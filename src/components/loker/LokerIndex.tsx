...
import { useLokerAlumni, useLokerAdmin, useLokerMitra, Filter } from '@/hooks/loker/useStore.hook';
...
export default function LokerIndex(){
    ...
    const { data: dataLokerMitra, index: indexMitra } = useLokerMitra();
    ...
    useEffect(() => {
      setFilter({
          ...
          TipeKerja: jobType ? jobType[0] : undefined,
      });
            ...
            <div className="basis-1/4 shrink-0">
                <div className="bg-white rounded-md p-3 border sticky top-5">
                    <div className="flex justify-between items-center text-base font-semibold">
                        ...
                        <div className="mt-4">
                            <h1 className="text-sm font-semibold text-gray-800">Pengalaman Kerja</h1>
                    ...
                    <div className="mt-4">
                        <h1 className="text-sm font-semibold text-gray-800">Tipe Kerja</h1>
                        <div className="text-lg">
                            ...
                            <div key={item.key} className="flex items-center gap-1 mb-1">
                                ...
                                value={item.value}
                                name="TipeKerja"
                                id={`TipeKerja-${item.key}`}
                                />
                                <label htmlFor={`TipeKerja-${item.key}`} className="text-sm">
                                {item.label}
                                </label>
                            </div>
                            ))}
                ...
                <div className="basis-full" >
                    <div className="flex gap-3 mb-3" >
                        ...
                        <button onClick={() => router.push("/dashboard/loker/manage")} className="bg-blueSTI hover:bg-blue-600 active:bg-blue-500 px-5 py-2 text-white font-semibold text-xs sm:text-sm rounded-md flex items-center justify-center gap-x-2 w-full sm:w-auto" > <HiCog /> Manage Lowongan</button>
                    </div>
                    ...
                    <div className="grid  gap-6">
                        <div className="grid grid-cols-2 w-full gap-6 ">
                        {
                            ...
                            ? (
                                <>
                                {/* Alumni */}
                                    {(!dataLokerAlumni?.length) ? (
                                        <div className="col-span-full text-center text-gray-500 p-4">
                                            Maaf, kami tidak menemukan lowongan pekerjaan yang sesuai.
                                        </div>
                                    ) : (
                                        <>
                                            {/* Data untuk Alumni */}
                                            {dataLokerAlumni.map((item) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        {/* Detail Lokasi, Jenis Pekerjaan, Gaji */}
